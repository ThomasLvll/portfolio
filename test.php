...
$github_user = (isset($_GET["user"])) ? $_GET["user"] : "ThomasLvll";
...
if (count($weeks) >= 7) {
    ...
    echo "<svg style='height: 80vmin;' xmlns='http://www.w3.org/2000/svg' viewBox='0 0 64 64' fill='" . $theme["BACKGROUND"] . "'>";
    $i = 0;
    foreach ($last_weeks as $week) {
        ...
        foreach ($week->contributionDays as $day) {
            ...
            $color = $theme[$level];
            echo "<rect width='7' height='7' x='$x' y='$y' rx='1' fill='$color'></rect>";
            $j ++;
        }
        $i ++;
    }
